...
function fetchData() {
  ...
  function getClickID(this_id, filteredData) {
    ...
    <div>
      ...
      <tr><td colspan="2" class="second_title">於建議時間前上線</td><td colspan="2" class="second_title">清空指定門市或時數達標</td><td colspan="2" class="second_title">上線指定門市上線配送</td></tr>
      ...
      <tr><th colspan="6">配送品質</th></tr><tr><td colspan="2" class="second_title">智能門市SOP執行率</td><td colspan="2" class="second_title">APPSHEET滯留包裹</td><td colspan="2" class="second_title">調度支援意願</td></tr><tr><td colspan="2">${smart_inbound}</td><td colspan="2">${appsheet}</td><td colspan="2">${extra_support}</td></tr>
      <tr><td></td></tr></table></div></li><li><input class="contentuse" type="radio" name="accordion" id="third_${idNum}"><label for="third_${idNum}">上線獎勵(${date})</label><div class="content"><table><tr><th colspan="6" class="first_th">上線獎勵結算</th></tr>
